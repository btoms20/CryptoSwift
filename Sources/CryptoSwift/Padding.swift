...
public enum Padding: PaddingProtocol {
  case noPadding, zeroPadding, pkcs7, pkcs5, pkcs1v15, iso78164, iso10126
  ...
  public func add(to: Array<UInt8>, blockSize: Int) -> Array<UInt8> {
    switch self {
      ...
      case .pkcs1v15:
        return PKCS1v15Padding().add(to: to, blockSize: blockSize)
      case .iso78164:
  ...
  public func remove(from: Array<UInt8>, blockSize: Int?) -> Array<UInt8> {
    switch self {
      ...
      case .pkcs1v15:
        return PKCS1v15Padding().remove(from: from, blockSize: blockSize)
      case .iso78164:
